...
Once it's built, you can run with the command below.  If you'd like to do this,
...
**Note**: on M1 Macs you likely need to rebuild the image and not
use the prebuilt image, otherwise you'll see `qemu` segfault during the build.
